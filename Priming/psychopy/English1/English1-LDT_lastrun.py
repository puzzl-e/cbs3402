...
expName = 'English1-LDT'  # from the Builder filename that created this script
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='For example, if you see MONKEY and then CHAIR, press J because CHAIR is a real word.\n\n(Press SPACE to read the next page of instructions.)',
        font='Open Sans',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_5 = visual.TextStim(win=win, name='text_5',
        text='If you see WALL and then BLICK, press F because BLICK is not a real word.\n\n(Press SPACE to read the next page of instructions.)',
        font='Open Sans',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    prTrials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('EnglishPractice.xlsx'), 
        seed=None, 
    )
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('English1.xlsx'), 
        seed=None, 
    )
